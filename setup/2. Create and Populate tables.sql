/*
Login with the user created in Script 1 then run below.

Using that user, script took 3m:15 sec at DWU 500

Steps are also This is also referenced in the following document
